...
// @EnableGlobalMethodSecurity(prePostEnabled = true) // deprecated - use EnableMethodSecurity which has prePostEnabled by default
// @PreAuthorize @PostAuthorize @PreFilter @PostFilter  -- prePostEnabled
// @Secured  -- securedEnabled
// @RoleAllowed  -- jsr250Enabled
@Configuration
